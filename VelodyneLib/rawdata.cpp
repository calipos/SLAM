...
namespace velodyne_rawdata
{
        ...
        double view_width)
    {
        ...
        //computing positive modulo to keep theses angles into [0;PIx2]
        config_.tmp_min_angle = fmod(fmod(config_.tmp_min_angle, PIx2) + PIx2, PIx2);
        config_.tmp_max_angle = fmod(fmod(config_.tmp_max_angle, PIx2) + PIx2, PIx2);

        //converting into the hardware velodyne ref (negative yaml and degrees)
        //adding 0.5 perfomrs a centered double to int conversion 
        config_.min_angle = 100 * (PIx2 - config_.tmp_min_angle) * 180 / PI + 0.5;
        config_.max_angle = 100 * (PIx2 - config_.tmp_max_angle) * 180 / PI + 0.5;
